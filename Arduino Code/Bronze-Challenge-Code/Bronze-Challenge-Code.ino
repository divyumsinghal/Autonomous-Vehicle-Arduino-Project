...
// Main execution loop function that runs continuously after setup
  ...
  void loop() 
  {
    ...
    else if (loopCounter == FrequencyOfTracking) 
    {
      // Execute obstacle tracking logic
      // Serial.print("Got into the 50th loop");

      checkPositionRelativeToObject();

      message = "Nearest Object: " +  ((nearestObstacleDistance != 100)? String(nearestObstacleDistance) : "Too far away!" );
