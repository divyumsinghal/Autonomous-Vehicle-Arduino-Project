...
const int PWMMin = 0;                          // Minimum PWM value (capping it at 50 instead of 225)
...
const float Ki = 0.0000005;  // Integral gain
const float Kd = 100;         // Derivative gain
