...
# 12 "C:\\Users\\divyu\\OneDrive - Trinity College Dublin\\Desktop\\Buggy\\Autonomous-Vehicle-Arduino-Project\\Arduino Code\\Silver-Challenge-Code\\Silver-Challenge-Code.ino" 2
// Include the library for WiFi communication using the NINA module
# 14 "C:\\Users\\divyu\\OneDrive - Trinity College Dublin\\Desktop\\Buggy\\Autonomous-Vehicle-Arduino-Project\\Arduino Code\\Silver-Challenge-Code\\Silver-Challenge-Code.ino" 2
...
double PIDSpeedObjectFollowing()
{
  ...
  nextSpeed_f_1 = ((nextSpeed_f_1)<(MinSpeedMmS)?(MinSpeedMmS):((nextSpeed_f_1)>(MaxSpeedMmS)?(MaxSpeedMmS):(nextSpeed_f_1)));
  ...
  */
# 155 "C:\\Users\\divyu\\OneDrive - Trinity College Dublin\\Desktop\\Buggy\\Autonomous-Vehicle-Arduino-Project\\Arduino Code\\Silver-Challenge-Code\\Silver-Challenge-Code.ino"
  _UART1_.println("F1 PID: " + String(nextSpeed_f_1));
...
double PIDSpeedMaintainSpeed()
{
  ...
  // Ensure the next speed is within bounds
  nextSpeed_m_2 = ((nextSpeed_m_2)<(MinSpeedMmS)?(MinSpeedMmS):((nextSpeed_m_2)>(MaxSpeedMmS)?(MaxSpeedMmS):(nextSpeed_m_2)));

  _UART1_.println("M2 PID: " + String(nextSpeed_m_2));
...
void sendMessage()
{
  /*
    ...
    */
# 355 "C:\\Users\\divyu\\OneDrive - Trinity College Dublin\\Desktop\\Buggy\\Autonomous-Vehicle-Arduino-Project\\Arduino Code\\Silver-Challenge-Code\\Silver-Challenge-Code.ino"
  /*
    ...
    */
# 366 "C:\\Users\\divyu\\OneDrive - Trinity College Dublin\\Desktop\\Buggy\\Autonomous-Vehicle-Arduino-Project\\Arduino Code\\Silver-Challenge-Code\\Silver-Challenge-Code.ino"
  /*
    ...
    */
# 374 "C:\\Users\\divyu\\OneDrive - Trinity College Dublin\\Desktop\\Buggy\\Autonomous-Vehicle-Arduino-Project\\Arduino Code\\Silver-Challenge-Code\\Silver-Challenge-Code.ino"
}
...
{
  _UART1_.print("Max forward at ");
  _UART1_.println(MaxSpeedMmS);

  _UART1_.print("Moving forward at ");
  _UART1_.println(speed);
...
void setup()
{
  ...
  /*
    ...
    */
# 706 "C:\\Users\\divyu\\OneDrive - Trinity College Dublin\\Desktop\\Buggy\\Autonomous-Vehicle-Arduino-Project\\Arduino Code\\Silver-Challenge-Code\\Silver-Challenge-Code.ino"
